...
4. zebra_rnh_eval_dependents() walks back and finds the parent nhe depends on this nhe, then replaces the parent nhe's depends tree for the new one, then performs a fast NHG refresh for the parent nhe
